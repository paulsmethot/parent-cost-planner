function TrustRow({ icon, text }) {
  return (
    <div className="flex items-center gap-3">
      <div className="w-8 h-8 rounded-full bg-[var(--color-warm-white)] flex items-center justify-center shrink-0">
        {icon}
      </div>
        ...
        <div className="w-full max-w-[540px] mx-auto space-y-8">
          ...
          <div className="space-y-3 py-1">
            <TrustRow
              icon={
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                  <path d="M8 1L10.163 5.382L15 6.111L11.5 9.524L12.326 14.344L8 12.073L3.674 14.344L4.5 9.524L1 6.111L5.837 5.382L8 1Z" stroke="var(--color-muted)" strokeWidth="1.5" strokeLinejoin="round"/>
                </svg>
              }
            ...
            <TrustRow
              icon={
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                  <rect x="3" y="7" width="10" height="8" rx="1.5" stroke="var(--color-muted)" strokeWidth="1.5"/>
                  <path d="M5 7V5a3 3 0 016 0v2" stroke="var(--color-muted)" strokeWidth="1.5" strokeLinecap="round"/>
                </svg>
              }
            ...
            <TrustRow
              icon={
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                  <circle cx="8" cy="8" r="6.25" stroke="var(--color-muted)" strokeWidth="1.5"/>
                  <path d="M8 5v3.5l2 1.5" stroke="var(--color-muted)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              }
